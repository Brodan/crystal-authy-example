...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Authy Example web application."
  #
  #
  ...
  #
  # settings.secret_key_base= lzZ7RQ0m_0Ir3YzgCYHCv8XvStH0CGEeveF885sM9FM
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("authy-example.log", "w"))
  #
  #
end
